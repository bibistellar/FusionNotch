...
class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    /// An agent is blocked waiting on the user; pop the notch open on the Agents tab.
    @objc private func handleAgentNeedsAttention() {
        guard Defaults[.agentsAutoOpenNotch] else { return }
